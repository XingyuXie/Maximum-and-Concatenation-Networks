...
class CifarResNeXt_MCN(nn.Module):
    ...
    def __init__(self, cardinality, depth, nlabels, base_width, widen_factor=4):
        ...
        self.MCN_block1 = models.MCN_block(xs_dim=[256,512,1024], out_dim = [256, 2048-256], x_strides= [4,2,1], bn_pool_flag = True)
        self.MCN_block2 = models.MCN_block(xs_dim=[256,1024,2048], out_dim = [256, 2048-256], x_strides= [8,2,2], bn_pool_flag = True)
